...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="space-y-6 pb-12 font-sans">
      ...
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-indigo-600 to-indigo-500 shadow-lg shadow-indigo-200">
        ...
        <div className="relative p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Button className="bg-white text-indigo-700 hover:bg-slate-50 font-bold px-6 h-11 rounded-xl shadow-sm">
              Pesan Sekarang
            </Button>
            <Button variant="outline" className="border-indigo-300 text-white hover:bg-indigo-500/50 hover:text-white bg-transparent font-bold px-6 h-11 rounded-xl">
              Lihat Detail
            </Button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="rounded-2xl border border-slate-200 shadow-sm flex flex-col">
        ...
        <Card className="rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
          <CardHeader className="p-5 pb-2 flex flex-row items-center justify-between">
            ...
            <span className="text-xs font-bold text-indigo-600 cursor-pointer">Lihat Semua</span>
          </CardHeader>
          ...
          {/* Floating Action Button purely for UI decoration as in mockup */}
          <div className="absolute bottom-4 right-4 w-10 h-10 bg-indigo-600 rounded-full shadow-lg shadow-indigo-200 flex items-center justify-center text-white cursor-pointer hover:bg-indigo-700 transition-colors">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="p-5 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Button className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold flex-1 md:flex-none">
              <ShoppingCart className="w-4 h-4 mr-2" />
              Proses Semua
            </Button>
            <Button variant="outline" className="border-slate-300 text-slate-700 hover:bg-slate-50 font-bold rounded-lg flex-1 md:flex-none">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                { name: 'MacBook Air M2', sku: 'LAP-001', stock: 12, daysLeft: 3, order: 50, vendor: 'Apple Inc.', prio: 'SANGAT TINGGI', prioColor: 'red', est: '12 Okt 2023' },
                { name: 'iPad Pro 11"', sku: 'TAB-842', stock: 28, daysLeft: 7, order: 30, vendor: 'Apple Inc.', prio: 'MEDIUM', prioColor: 'amber', est: '15 Okt 2023' },
                { name: 'Magic Keyboard', sku: 'ACC-899', stock: 5, daysLeft: 2, order: 100, vendor: 'Logitech', prio: 'KRITIKAL', prioColor: 'red', est: '10 Okt 2023' },
              ].map((r, i) => (
