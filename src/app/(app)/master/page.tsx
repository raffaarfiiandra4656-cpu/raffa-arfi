...
import { ChevronRight, PackageOpen, Layers, MapPin, Users, Settings, Shield, LogOut, Bell, HelpCircle, UserPlus, Mail } from 'lucide-react'
...
export default async function MasterDataPage() {
  ...
  const adminMenu = [
    ...
    { title: 'Undangan Tim', icon: Mail, href: '/admin/invitations', desc: 'Kirim undangan akses via link', color: 'text-emerald-600', bg: 'bg-emerald-100' },
